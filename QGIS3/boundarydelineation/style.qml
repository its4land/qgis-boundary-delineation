...
<qgis labelsEnabled="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" maxScale="0" simplifyAlgorithm="0" readOnly="0" simplifyMaxScale="1" version="3.2.2-Bonn" minScale="1e+8" simplifyDrawingTol="1">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  ...
                  <Option type="QString" name="expression" value="&quot;boundary&quot; * -1"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory minScaleDenominator="0" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" backgroundAlpha="255" height="15" scaleBasedVisibility="0" minimumSize="0" width="15" penColor="#000000" sizeType="MM" rotationOffset="270" scaleDependency="Area" penAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" diagramOrientation="Up" barWidth="5" penWidth="0" enabled="0" backgroundColor="#ffffff" opacity="1" maxScaleDenominator="1e+8">
      <fontProperties description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings placement="2" linePlacementFlags="18" zIndex="0" priority="0" dist="0" showAll="1" obstacle="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
  ...
  <defaults>
    ...
    <default field="vertices" expression="" applyOnUpdate="0"/>
    <default field="length" expression="" applyOnUpdate="0"/>
    <default field="azimuth" expression="" applyOnUpdate="0"/>
    <default field="sinuosity" expression="" applyOnUpdate="0"/>
    <default field="red_grad" expression="" applyOnUpdate="0"/>
    <default field="green_grad" expression="" applyOnUpdate="0"/>
    <default field="blue_grad" expression="" applyOnUpdate="0"/>
    <default field="dsm_grad" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" field="ID" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="boundary" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="vertices" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="length" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="azimuth" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="sinuosity" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="red_grad" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="green_grad" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="blue_grad" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="dsm_grad" constraints="0" exp_strength="0" unique_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="vertices" hidden="0"/>
      <column width="-1" type="field" name="length" hidden="0"/>
      <column width="-1" type="field" name="azimuth" hidden="0"/>
      <column width="-1" type="field" name="sinuosity" hidden="0"/>
      <column width="-1" type="field" name="red_grad" hidden="0"/>
      <column width="-1" type="field" name="green_grad" hidden="0"/>
      <column width="-1" type="field" name="blue_grad" hidden="0"/>
      <column width="-1" type="field" name="dsm_grad" hidden="0"/>
